...
const BrandIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path
      d="M35 22 L28 33 L33 33 L29 42 L38 29 L33 29 Z"
      fill="white"
      opacity="0.95"
    />
  </svg>
        ...
        <div className="hidden md:flex items-center gap-2">
          {user ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="w-52 bg-white border-stone-200"
              >
                ...
                <DropdownMenuItem asChild>
                  <Link
                    to="/settings"
                    className="gap-2 cursor-pointer text-stone-700"
                  >
            ...
            <div className="flex items-center gap-2">
              <Link to="/login">
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-stone-600 hover:text-stone-900 hover:bg-stone-100 rounded-xl font-sans"
                >
                  Log in
                </Button>
              </Link>
              <Link to="/signup">
                <Button
                  size="sm"
                  className="bg-[#E8743A] hover:bg-[#D4632A] text-white rounded-xl font-sans font-semibold shadow-brand hover:shadow-[0_6px_20px_rgba(232,116,58,0.4)] transition-all active:scale-[0.98]"
                >
                  Get started
                </Button>
              </Link>
